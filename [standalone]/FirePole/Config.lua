...
Config.PoleLocations = {
    ...
    ["FD Pole"] = {
        ["Start Locations"] = { -- Inside this table is the coordinates for
            vector3(-1030.19, -1390.63, 11.23),   -- where you can get onto the pole.
            vector3(0.0, 0.0, 80.0),   -- You can add as many lines as you wish.
            vector3(0.0, 0.0, 75.0),
        },
        ["End Z Coordinate"] = 5.0, -- This is the Z coordinate for where the pole ends.
        ["Heading"] = 311.05, -- This is the heading to set the player to when they get on the pole.
    },
