...
Config.CashItem                       = false  -- If you want to use cash item, set this to true or false
...
Config.ThrowablesSystem               = true   -- If you want to use throwables system, set this to true or false
Config.SlingWeapon                    = true   -- If you want to use sling weapon system, set this to true or false
Config.DiePlayerRemoveHandsWeaponItem = true  -- If you want to remove weapon item when player die, set this to true or false
Config.MaxBackPackItem                = 10
...
Config.Stashs = {
    ["policestash"] = {
        ...
        coords = vector3(-392.44, -356.58, 25.1)
    },
    ["sheriffstash"] = {
        label = "Sheriff",
        maxweight = 35000,
        ...
        coords = vector3(-396.39, -378.3, 25.1)
    },
    ["saspstash"] = {
        label = "SASP",
        maxweight = 35000,
        ...
        coords = vector3(-394.81, -381.0, 25.1)
    },
    ["firefighterstash"] = {
        label = "Firefighter",
        maxweight = 35000,
        ...
        coords = vector3(-1033.97, -1424.94, 4.97)
    },
    ["ambulancestash"] = {
        label = "Ambulance",
        maxweight = 35000,
        ...
        coords = vector3(-1035.23, -1424.9, 4.97)
    },
    ["personelstash"] = {
        label = "Personel",
        maxweight = 35000,
