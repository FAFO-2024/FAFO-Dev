local ShopItems = {
    ...
    ["9"] = { name = "harness", price = 80 },
    ["10"] = { name = "phone", price = 80 },
    ["11"] = { name = "powerbank", price = 80 },
}
...
Config.Shops = {
    ["policeshop"] = {
        ...
        items = {
            ["1"] = { name = "weapon_pistol", price = 1, grade = 1 },
            ["2"] = { name = "weapon_pumpshotgun", price = 10, },
            ["3"] = { name = "weapon_carbinerifle", price = 10, },
            ["4"] = { name = "weapon_stungun", price = 10, },
            ["5"] = { name = "pistol_ammo", price = 10, },
            ["6"] = { name = "shotgun_ammo", price = 10, },
            ["7"] = { name = "rifle_ammo", price = 10, },
            ["8"] = { name = "weapon_flashlight", price = 10, grade = 1 },
            ["9"] = { name = "handcuffs", price = 10, grade = 1 },
            ["10"] = { name = "weapon_nightstick", price = 10, },
            ["11"] = { name = "empty_evidence_bag", price = 10, },
            ["12"] = { name = "police_stormram", price = 10, },
            ["13"] = { name = "radio", price = 10, },
            ["14"] = { name = "heavyarmor", price = 10, },
            
        },
        coords = vector3(-403.11, -377.45, 25.1)
    },
    ["saspshop"] = {
        label = "SASP Shop",
        Blip = {
