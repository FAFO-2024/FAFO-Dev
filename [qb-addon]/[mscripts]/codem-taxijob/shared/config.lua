...
Config.NewESX = false -- true enabled -- false disabled
...
Config.KmPrice = 3.1
Config.InteractionHandler = "qb-target" -- bt-target, qb-target -- drawtext -- ox_target
...
Config.DepositeVehicle = {
    ['deposite'] = true,   -- true enabled -- false disabled
    ['depositePrice'] = 1500,
...
Config.GiveVehicleKey = function(plate , vehicle) -- you can change vehiclekeys export if you use another vehicle key system
...
Config.Locale ={
    ...
    ['EARNING'] = 'Fare',
    ['EXP'] = 'EXP',
    ['YOUWILLUSEDOWNTOWN'] = 'You will use Downtown Cab vehicle.',
    ...
    ['NOTCARRYING'] = 'You are not carrying a passenger.',
