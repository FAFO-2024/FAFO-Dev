...
HSN.Config = {
    ...
    DiscordBotToken = "MTIzNzgxNDQ0ODEzMTkzNjM0OQ.Ga35Zq.OAY8nZWCnMVYverj_EnBuK0HYDspohM_S-JCtI", -- discord bot token for user image
...
HSN.Messages = {
    client = {
        ["waypointsetforgardrop"] = "Waypoint set to take Badge!!",
        ["vehicleset"] = "Set your vehicle!",
        ["vehiclenotfound"] = "We can not find your car!",
        ["finishjob"] = "You finished the job! You should to park your vehicle at Post Op. Garage. also refunded your badge price!",
        ["finishjobyourtruck"] = "You finished the job! also refunded your badge price!",
        ["returncar"] = "You need to get the car to start work",
    },
    server = {
        ["needbadge"] = "You need to get your Badge!",
        ["setclothes"] = "You took your Badge!",
        ["startjob"] = "Your job has been started with : ",
        ["earnmoney"] = "You earned :",
        ["enoughmoney"] = "You don't have enough money for a badge!",
