...
Config.Dealer = {
    ...
    buyableItems = {
        ...
        },
        {
            ...
            price = 3,
            info = 'A cannabis seed that provide sativa weed and by chance sativa joint lemon haze joint, purple haze joint.',
        },
        {
        ...
        },
        {
            ...
            price = 1,
            info = 'A paper that used for rolling a joint process. Every 1g weed will use x4 RAW Paper. 1 Package contains x20 paper. ',
        },
        {
            name = Config.Items["grinder"].name,
            label =  Config.Items["grinder"].label,
            price = 1,
            info = 'A grinder that used for grinding weeds. You need this item to grind your weed and gain grinded weed for rolling a joint process.'
        },                                         
    },
    sellableItems = {
        {
...
Config.Translation = {
    ["DEALER"] = {
        ...
        ["BUY_WEEDS_DESC"] = "Welcome {0}, here is some materials that you can use it to produce your own drugs or you can sell your drugs to me.",
    ...
    ["GRINDER"] = {
        ...
        ["GRIND_WEEDS_DESC"] = "You need to grind your weeds to roll a joint. Grind the weed and you will gain 1g grinded weed.",
        ["CONGRATS"] = "CONGRATS",
