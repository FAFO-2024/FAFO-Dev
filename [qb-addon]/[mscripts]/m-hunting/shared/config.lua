...
Config.Inventory = 'codem_inventory' -- qb , esx , ox_inventory, codem_inventory (if you are using a different inventory you can write your default framework e.g QBCore qs-inventory 'qb' or ESX qs-inventory 'esx')
...
Config.FuelSystem = 'cdn-fuel' -- LegacyFuel / ox-fuel / nd-fuel / frfuel / cdn-fuel / hyon_gas_station
