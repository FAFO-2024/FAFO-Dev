...
Config.Hash = {
	{hash = "f550ambow", detection = 2.4, depth = -1.0, height = 0.0},
	{hash = "f550ambows", detection = 2.4, depth = -1.0, height = 0.0},
	{hash = "f550amboc", detection = 2.4, depth = -1.0, height = 0.0},
	{hash = "f550amboc2", detection = 2.4, depth = -1.0, height = 0.0},
	{hash = "f550amboc2s", detection = 2.4, depth = -1.0, height = 0.0},
	{hash = "f550ambocs", detection = 2.4, depth = -1.0, height = 0.0},
}
