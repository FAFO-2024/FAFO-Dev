...
--[[     {
    ...
    { --PDCLothing
        type = "clothing",
        coords = vector4(463.47, -1004.72, 30.69, 358),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false, -- false => uses the size + rotation to create the zone | true => uses points to create the zone
    ...
    { --Firefighter
    type = "clothing",
    coords = vector4(-1235.35, -1816.45, 4.1, 307.35),
    size = vector3(4, 4, 4),
    rotation = 45,
    usePoly = false, -- false => uses the size + rotation to create the zone | true => uses points to create the zone
    showBlip = false, -- overrides the blip visibilty configured above for the group
    ...
    { --EMSCLothing
    type = "clothing",
    coords = vector4(306.79, -600.44, 43.27, 338),
    size = vector3(4, 4, 4),
    rotation = 45,
    usePoly = false, -- false => uses the size + rotation to create the zone | true => uses points to create the zone
    showBlip = false, -- overrides the blip visibilty configured above for the group
...
{ --StaffClothing
    type = "clothing",
    coords = vector4(258.58, -795.16, 55.23, 64.0),
    size = vector3(4, 4, 4),
    rotation = 45,
    usePoly = false, -- false => uses the size + rotation to create the zone | true => uses points to create the zone
    showBlip = false, -- overrides the blip visibilty configured above for the group
...
{ --The Lux Club Clothing
type = "clothing",
coords = vector4(-317.83, 209.19, 81.78, 4.0),
size = vector3(4, 4, 4),
rotation = 45,
usePoly = false, -- false => uses the size + rotation to create the zone | true => uses points to create the zone
showBlip = false, -- overrides the blip visibilty configured above for the group
...
points = {
   ...
   {
        type = "clothing",
        coords = vector4(-566.87, -586.17, 34.68, 179.0),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        showBlip = true,
    ...
    {
        type = "clothing",
        coords = vector4(-525.71, -598.08, 41.43, 181.0),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        showBlip = true,
    ...
    {
        type = "clothing",
        coords = vector4(617.62, 2759.68, 42.09, 185),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        showBlip = true,
    ...
    {
        type = "barber",
        coords = vector4(-552.99, -583.84, 41.43, 174),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        showBlip = true,
...
-- Sandy
    {
        type = "barber",
        coords = vector4(1932.20, 3728.98, 32.84, 207),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        showBlip = true,
    ...
    { 
        type = "tattoo",
        coords = vector4(-588.11, -601.24, 41.43, 253),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        showBlip = true,
    ...
    { 
        type = "tattoo",
        coords = vector4(1864.28, 3747.67, 33.03, 0),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        showBlip = true,
   ...
   --[[  {
    ...
    {
        type = "surgeon",
        coords = vector4(333.55, -572.82, 43.27, 150.38),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
