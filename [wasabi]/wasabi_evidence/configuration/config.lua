...
Config.Gloves = {
    enabled = true, -- Enable ability for defined gloves to conceal identity of player for all evidence except blood
...
Config.BlacklistedWeapons = { -- Execlude weapons e.g. for lazer tag weapons
...
-- Copy starting here to add new location
    LEO = {
        ...
        label = 'LEO', -- Label to display during certain situations/notifications
