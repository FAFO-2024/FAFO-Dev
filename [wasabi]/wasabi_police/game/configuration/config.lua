...
Config.billingData = {
    ...
    societyName = 'police', 'sasp', 'sheriff', --Name of the society to deposit the charge amount
    fines = {               --Fine presets
...
Config.RadarPosts = {      -- Radar posts for speed detection
    ...
    creditSociety = 'police', 'sasp', 'sheriff',
...
Config.GSR = {                 -- Gunshot residue settings
    ...
    timeToClean = 30 * seconds, -- How long to clean GSR in water if enabled
...
Config.handcuff = {                             -- Config in regards to cuffing
    ...
    timer = 60 * minutes,                       -- Time before player is automatically unrestrained(Set to false if not desired)
    ...
    lockpicking = {                             -- Lockpicking someone else out of handcuffs
        ...
        item = 'bobby_pin',
        breakChance = 35,                       -- Chance of lockpick breaking if failed (Set to 100 for 100% or 0 for never breaking)
        difficulty = { 'easy', 'medium', 'hard' } -- Options: 'easy' / 'medium' / 'hard' (Can be stringed along as they are in config)
    }
}
...
Config.GPSBlips = {  -- Warning: May experience high usage when at high player count. Possibly turn up refreshrate as remedy!
    enabled = true, -- Enabled?
    refreshrate = 20, -- In Seconds Note: it could impact the server performance
...
Config.Locations = {
    LSPD = {
        blip = {
            enabled = true,
            coords = vector3(588.62, -5.9, 82.79),
            sprite = 60,
            color = 29,
            scale = 1.0,
        ...
        clockInAndOut = {
            ...
            jobLock = 'police', 'sasp', 'sheriff', -- This must be set to which job will be utilizing (ESX MUST HAVE OFF DUTY JOB / GRADES FOR THIS - ex. offpolice or offsheriff)
            coords = vector3(619.4, 12.74, 82.79), -- Location of where to go on and off duty(If not using target)
            ...
            target = {
                ...
                coords = vector3(619.4, 12.74, 82.79),
                heading = 274.94,
                distance = 2.5,
                width = 2.0,
                length = 1.0,
        ...
        personalLocker = {
            ...
            jobLock = 'police','sasp','sheriff',   -- Job lock?
            coords = vector3(593.44, -12.1, 82.79),-- Area to prompt personal locker
            ...
            target = {
                ...
                coords = vector3(593.44, -12.1, 82.79),
                heading = 251.54,
                distance = 2.5,
                width = 2.0,
                length = 1.0,
        ...
        evidenceLocker = {
            ...
            jobLock = 'police','sasp','sheriff',   -- Job lock?
            coords = vector3(572.06, 43.56, 70.63),-- Area to prompt personal locker
            range = 2.0,                           -- Range it will prompt from coords above
            label = '[E] - Access Evidence Locker',
            target = {
                enabled = true, -- If enabled, the location above will be obsolete
                label = 'Access Evidence Locker',
                coords = vector3(572.06, 43.56, 70.63),
                heading = 357.01,
                distance = 2.5,
                width = 2.0,
                length = 1.0,
