...
QBShared.Jobs = {
	...
	miner = { label = 'Miner', defaultDuty = true, offDutyPay = false, grades = { ['0'] = { name = 'Miner', payment = 50 } } },
	...
	ambulance = {
		...
		grades = {
			...
			['3'] = { name = 'Asst Director', isboss = true, payment = 125, bankAuth = true },
			['4'] = { name = 'Med Director', isboss = true, payment = 150, bankAuth = true },
		},
	},
	firefighter = {
		label = 'Firefighter',
	...
	lux = {
		...
		offDutyPay = false,
		grades = {
			['1'] = { name = 'Staff', isboss = true, payment = 0, bankAuth = true },
		},
	},
