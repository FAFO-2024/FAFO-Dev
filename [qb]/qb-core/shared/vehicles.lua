...
local Vehicles = {
    ...
    --- Addon (23)
    { model = 'nm_redeye',     name = 'Red Eye',                       brand = 'Dodge',           price = 100000,  category = 'VC_EMERGENCY',   type = 'automobile', shop = 'pdm' },
    { model = 'nm_raptor',     name = 'Raptor',                        brand = 'Ford',            price = 100000,  category = 'VC_EMERGENCY',   type = 'automobile', shop = 'pdm' },
    { model = 'nm_bolide',     name = 'Bolide',                        brand = 'Bugatti',         price = 100000,  category = 'VC_EMERGENCY',   type = 'automobile', shop = 'pdm' },
    { model = 'nm_cam69',      name = 'Camaro',                        brand = 'Chevy',           price = 100000,  category = 'VC_EMERGENCY',   type = 'automobile', shop = 'pdm' },
    { model = 'c3swathawk',    name = 'Air One',                       brand = 'Sikorsky',        price = 100000,  category = 'VC_EMERGENCY',   type = 'automobile', shop = 'pdm' },
    { model = 'durangopru',    name = 'Medical Chief',                 brand = 'Dodge',           price = 100000,  category = 'VC_EMERGENCY',   type = 'automobile', shop = 'pdm' },
    { model = 'c3medhawk',     name = 'Life Flight',                   brand = 'Sikorsky',        price = 100000,  category = 'VC_EMERGENCY',   type = 'automobile', shop = 'pdm' },
    { model = 'fdsilverado',   name = 'Fire Chief',                    brand = 'Chevy',           price = 100000,  category = 'VC_EMERGENCY',   type = 'automobile', shop = 'pdm' },
    { model = 'quantum',       name = 'Quantum',                       brand = 'Pierce',          price = 100000,  category = 'VC_EMERGENCY',   type = 'automobile', shop = 'pdm' },
    { model = 'as365',         name = 'AS365',                         brand = 'Airbus',          price = 100000,  category = 'VC_EMERGENCY',   type = 'automobile', shop = 'pdm' },
    { model = 'carrierpete',   name = 'Auto Hauler',                   brand = 'Peterbuilt',      price = 100000,  category = 'VC_EMERGENCY',   type = 'automobile', shop = 'pdm' },
    { model = 'carrier',       name = 'Auto Hauler',                   brand = 'Cottrell',        price = 100000,  category = 'VC_EMERGENCY',   type = 'automobile', shop = 'pdm' },
    { model = 'jp18charger',   name = 'Charger',                       brand = 'Dodge',           price = 100000,  category = 'VC_EMERGENCY',   type = 'automobile', shop = 'pdm' },
    { model = 'jp18chargerst', name = 'Charger Slicktop',              brand = 'Dodge',           price = 100000,  category = 'VC_EMERGENCY',   type = 'automobile', shop = 'pdm' },
    { model = '18tahoe',       name = 'Tahoe',                         brand = 'Chevy',           price = 100000,  category = 'VC_EMERGENCY',   type = 'automobile', shop = 'pdm' },
    { model = '18tahoest',     name = 'Tahoe Slicktop',                brand = 'Chevy',           price = 100000,  category = 'VC_EMERGENCY',   type = 'automobile', shop = 'pdm' },
    { model = 'jp20fpiu',      name = 'Explorer',                      brand = 'Ford',            price = 100000,  category = 'VC_EMERGENCY',   type = 'automobile', shop = 'pdm' },
    { model = 'jp20fpiust',    name = 'Explorer Slicktop',             brand = 'Ford',            price = 100000,  category = 'VC_EMERGENCY',   type = 'automobile', shop = 'pdm' },
    { model = 'jpdurango',     name = 'Durango',                       brand = 'Dodge',           price = 100000,  category = 'VC_EMERGENCY',   type = 'automobile', shop = 'pdm' },
    { model = 'jpdurangost',   name = 'Durango Slicktop',              brand = 'Dodge',           price = 100000,  category = 'VC_EMERGENCY',   type = 'automobile', shop = 'pdm' },
    { model = 'jpfpis',        name = 'Taurus',                        brand = 'Ford',            price = 100000,  category = 'VC_EMERGENCY',   type = 'automobile', shop = 'pdm' },
    { model = 'jpfpisst',      name = 'Taurus Slicktop',               brand = 'Ford',            price = 100000,  category = 'VC_EMERGENCY',   type = 'automobile', shop = 'pdm' },
    { model = 'jpram',         name = 'Ram',                           brand = 'Dodge',           price = 100000,  category = 'VC_EMERGENCY',   type = 'automobile', shop = 'pdm' },
    { model = 'jpramst',       name = 'Ram Slicktop',                  brand = 'Dodge',           price = 100000,  category = 'VC_EMERGENCY',   type = 'automobile', shop = 'pdm' },
}
